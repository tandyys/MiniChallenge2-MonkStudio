...
class GameScene1: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let gate = SKSpriteNode(imageNamed: "Gate 1")
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if towerRedActivate == true && towerPurpleActivate == true && towerBlueActivate == true && towerGreenActivate == true{
            let reveal = SKTransition.fade(withDuration: 0.5)
            let scene = MidlogVideoScene(size: size)

...
extension GameScene31{
    func createWhite1ProgressBar(at position: CGPoint) {
        ...
        white1ProgressBar.zPosition = SKSpriteNode.Layer.label.rawValue
        addChild(white1ProgressBar)
        
        white1ProgressBar = SKSpriteNode(imageNamed: "RedTowerProgBarMask")
        ...
        white1CropNode.maskNode = white1ProgressBar
        white1CropNode.zPosition = SKSpriteNode.Layer.progressBar.rawValue
        white1CropNode.addChild(white1ProgressBar)
        
        addChild(white1CropNode)
    }
    ...
    func createWhite2ProgressBar(at position: CGPoint) {
        ...
        white2ProgressBar.zPosition = SKSpriteNode.Layer.label.rawValue
        self.addChild(white2ProgressBar)
        
        white2ProgressBarBg = SKSpriteNode(imageNamed: "RedTowerProgBarMask")
        ...
        white2CropNode.maskNode = white2ProgressBar
        white2CropNode.zPosition = SKSpriteNode.Layer.progressBar.rawValue
        white2CropNode.addChild(white2ProgressBar)
    ...
    func createWhite3ProgressBar(at position: CGPoint) {
        ...
        white3ProgressBar.zPosition = SKSpriteNode.Layer.label.rawValue
        self.addChild(white3ProgressBar)
        
        white3ProgressBarBg = SKSpriteNode(imageNamed: "RedTowerProgBarMask")
        ...
        white3CropNode.maskNode = white3ProgressBar
        white3CropNode.zPosition = SKSpriteNode.Layer.progressBar.rawValue
        white3CropNode.addChild(white3ProgressBar)
        
        self.addChild(white3CropNode)
    }
    
    func updateWhite1ProgressBar(_ buttonPressedType: Double) {
        let white1 = min(buttonPressedType / maxPressedTime, 1.0)
        white1ProgressBar.size.width = white1 * white1ProgressBar.size.width
    }
    func updateWhite2ProgressBar(_ buttonPressedType: Double) {
        let white2 = min(buttonPressedType / maxPressedTime, 1.0)
        white2ProgressBar.size.width = white2 * white2ProgressBar.size.width
    }
    func updateWhite3ProgressBar(_ buttonPressedType: Double) {
        let white3 = min(buttonPressedType / maxPressedTime, 1.0)
        white3ProgressBar.size.width = white3 * white3ProgressBar.size.width
    }
